...
_MESSAGES = {
    ...
    "INVALID_REAUTHENTICATION": "رمز عبور درست نیست.",
    "RECENT_AUTHENTICATION_REQUIRED": "برای ادامه، دوباره وارد حساب شوید.",
    ...
    "MEMBER_NOT_ALLOWED": "این بررسی متعلق به شما نیست.",
    "REVIEW_NOT_AWAITING_MEMBER_ACCEPTANCE": "این برنامه در انتظار تایید عضو نیست.",
    "REVIEW_PROPOSAL_NOT_FOUND": "نسخه پیشنهادی برنامه پیدا نشد.",
    "PLAN_STRUCTURE_CHANGED": "ساختار روزها و حرکت‌های برنامه نباید تغییر کند.",
    "PLAN_STRUCTURE_INVALID": "ترتیب روزها و حرکت‌های برنامه معتبر نیست.",
