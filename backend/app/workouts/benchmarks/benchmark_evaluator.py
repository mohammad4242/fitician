    ...
    if safety_assessment.status not in {SafetyStatus.CLEAR, SafetyStatus.CLEAR_WITH_MODIFICATIONS}:
        ...
        return {
            ...
            "failure_info": {
                ...
                "limit_val": "CLEAR / CLEAR_WITH_MODIFICATIONS",
                "failing_phase": "safety_screening",
                "exact_description_fa": f"ارجاع پزشکی به دلیل وضعیت ریسک پزشکی ({safety_assessment.status.value}) و رد پیش از صدور برنامه طبق قرارداد ایمنی فیتیشن.",
        ...
        if bw_decision.status is BodyweightRoutingStatus.UNSUPPORTED_LEVEL:
            return {
                ...
                "failure_info": {
                    ...
                    "exact_description_fa": "تمرین با وزن بدن در منزل برای سطوح متوسط و پیشرفته در قرارداد محصول فیتیشن پشتیبانی نمی‌شود.",
    ...
    try:
        ...
        return {
            ...
            "failure_info": {
                ...
                "limit_val": "تطابق با ماتریس مجاز تمرین مقاومتی فیتیشن",
                "failing_phase": "input_compatibility_validation",
                "exact_description_fa": f"سطح سابقه '{FA_TRANSLATIONS.get(spec.experience_level.value, spec.experience_level.value)}' با {spec.training_days_per_week} روز در هفته طبق ماتریس مجاز فیتیشن ناسازگار است.",
                "engine_repair_hint_fa": "این رد عمدی و طبق قرارداد محصول است.",
            },
            "program_days": [],
            "warnings": [],
