...
- [ ] Add the enum, nullable-free model column with server default `fitician_coach`, additive create/update/response schema fields, and service mapping.
...
- [ ] Dispatch to the existing deterministic engine for `fitician_coach`; adapt the existing prompt/provider/validator flow for AI mode.
