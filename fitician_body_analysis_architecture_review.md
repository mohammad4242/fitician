# Fitician Body Analysis — Proposed Product & Architecture for Review

## Purpose

This document describes a proposed redesign of Fitician's **Body Analysis** feature.
...
These measurements do not necessarily need to be mandatory for the entire Fitician app.
...
Fitician opens the camera inside the app and displays a ghost silhouette overlay.
...
4. Should the friendly opening be generated by the model, Fitician templates, or a hybrid?
