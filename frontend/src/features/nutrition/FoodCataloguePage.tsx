...
function FoodImage({ food, language }: { food: FoodCatalogueItem; language: "fa" | "en" }) {
  ...
  return <img className="food-shelf-card__image" src={publicMediaPath(food.image_url)} alt={name} onError={() => setFailure({ imageUrl: food.image_url, failed: true })} />;
}
...
function formatDate(value: string, language: "fa" | "en") {
  return formatTehranDateForLocale(value, language === "fa" ? "fa-IR" : "en-US", { dateStyle: "short" });
}
